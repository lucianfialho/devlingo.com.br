      ...
      <form onSubmit={handleSubmit}>
        <div className="flex items-center justify-center gap-x-4 w-full">
          ...
          <input
            ...
            autoComplete="email"
            required
            className="sm:min-w-72 w-3/4 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-black dark:text-white  shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
