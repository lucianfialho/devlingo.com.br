        ...
        <Body className="bg-gray-100 my-auto mx-auto font-sans px-2">
          <Container className="my-[40px] mx-auto p-[20px] max-w-[600px]">
            ...
            <Text className="text-[32px] text-center text-white text-center bg-gray-900 py-24 m-0 leading-[36px]">
              {`🇺🇸 "Hello World"`} <br/>
              <em className="text-[24px] mt-[6px]">{`🇧🇷 "Olá mundo"`}</em>
            </Text>
            
            <Section className="mt-[0px] bg-white px-10 py-5 hidden sm:block rounded-md rounded-tl-none	rounded-tr-none">
            <Row>
                  <Column valign="top">
                    <strong className="text-[18px] text-gray-400">{`frase`}</strong>
                  </Column>

                  <Column valign="right">
                    <ol className="mt-0 pt-0">
                    <li className="text-[16px] mb-4">A frase "Hello, world!" é comumente usada como uma mensagem simples em programação. Os programadores a utilizam para criar programas que exibem essa saudação na tela ou em outro dispositivo de saída.</li>
                    <li className="text-[16px] mb-4">"Hello, world!" é um padrão cultural na programação, frequentemente usado como o primeiro programa por iniciantes. Escrever esse programa simples ajuda a aprender a sintaxe básica da linguagem, compilação e execução de programas.</li>
                    </ol>
                  </Column>
                </Row>
            </Section>
            ...
            <Section className="mt-[32px] mb-[32px] bg-white px-10 py-5 rounded-md">
              ...
              <Row>
                ...
                <Text className="bg-red-800 text-yellow-300 h-20 w-28 flex items-center justify-center font-bold text-base p-4 rounded">Algorithm</Text>
                </Column>
                <Column valign="middle">
                <Text className="bg-blue-600 text-gray-100 font-bold h-20 w-28 flex items-center justify-center p-4 rounded">Back-end Development</Text>
                  
                </Column>
                <Column valign="middle">
                <Text className="bg-yellow-300 text-green-800 font-bold h-20 w-28 flex items-center justify-center p-4 rounded">Code Review</Text>
                  
                </Column>
              </Row>
              <Row>
              <Column valign="middle"><Text className="bg-green-300 text-yellow-800 font-bold h-20 w-28 flex items-center justify-center p-4 rounded">Front-end Development</Text></Column>
                  <Column valign="middle"><Text className="bg-orange-200 text-gray-600 font-bold h-20 w-28 flex items-center justify-center p-4 rounded">Scrum</Text></Column>
                  <Column valign="middle"><Text className="bg-pink-300 text-gray-100 font-bold h-20 w-28 flex items-center justify-center p-4 rounded">DevOps</Text></Column>
              </Row>
            </Section>
            ...
            <Section className="mt-[32px] mb-[32px] bg-white px-10 py-5 rounded-md">
              ...
              <Row>
                <Column>
                <h3 className="text-[24px] font-normal"> Como você contribui para o nosso crescimento?</h3>
                </Column>
              </Row>
